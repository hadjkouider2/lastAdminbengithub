...
$sql = "SELECT * FROM cat WHERE id= $cid LIMIT 1";
...
if ($edit == 'ok') {
    ...
    $sqlU = "UPDATE cat SET nom='$nom', detail='$detail' WHERE id=$id";
                                ...
                                <form action="" method="post">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="detail" placeholder="Enter detail" value="<?= $data["detail"] ?>">
                                        </div>
