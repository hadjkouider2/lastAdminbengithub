...
<body>
    <header class="titleCommand">
        ...
        <nav class="navigation mt-1">
            <button class="btnlogin-popup"><a href="front.php">Welcome</a></button>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-md-7 text-center border-primary">
                    ...
                    <p class="color-black-opacity-5 text-primary ">Nos articles les plus demandé</p>
                </div>
            </div>
        </div>
        <div class="container">
                    ...
                    <div class="col">
                        ...
                        <div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="front.php" name="add" class="btn btn-primary">Add To Cart</a>
                            </div>
                        </div>
